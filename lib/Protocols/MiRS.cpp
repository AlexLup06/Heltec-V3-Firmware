...
String MiRS::getProtocolName() { return "mirs"; }

void MiRS::handleWithFSM()
{
    FSMA_Switch(fsm)
    {
        ...
        FSMA_State(BACKOFF)
        {
            ...
            FSMA_Event_Transition(backoff finished send rts,
                                  regularBackoff.finished() && withRTS(false),
                                  SEND_RTS,
        ...
        FSMA_State(CW_CTS)
        {
            ...
            FSMA_Event_Transition(cts backoff finished and we send cts,
                                  ctsBackoff.finished() && !isReceiving(),
                                  SEND_CTS,
            ...
            FSMA_Event_Transition(got cts sent to same source as we want to send to,
                                  ...
                                  ctsBackoff.cancel();
                                  clearRTSsource();
                                  transmissionStartTimer.schedule(sifs_MS););
...
void MiRS::handleUpperPacket(MessageToSend_t *msg)
{
    if (msg->isMission)
    {
...
void MiRS::handleRTS(const BroadcastRTSPacket_t *packet, const size_t packetSize, bool isMission)
{
...
void MiRS::handleLeaderFragment(const BroadcastLeaderFragmentPacket_t *packet, const size_t packetSize, bool isMission)
{
...
void MiRS::handleContinuousRTS(const BroadcastContinuousRTSPacket_t *packet, const size_t packetSize, bool isMission)
{
...
void MiRS::handleFragment(const BroadcastFragmentPacket_t *packet, const size_t packetSize, bool isMission)
{
...
void MiRS::handleCTS(const BroadcastCTS_t *packet, const size_t packetSize, bool isMission)
{
